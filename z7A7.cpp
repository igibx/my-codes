...
int main(void)
{
    ...
    while (!WindowShouldClose()) 
    {
        ...
        BeginDrawing();
            ...
            DrawRectangleRoundedLines(btnIA, 0.3f, 10, 3, GREEN);
            ...
            DrawRectangleRoundedLines(btnLili, 0.2f, 10, 4, mortoLili ? GRAY : DARKBLUE);
            ...
            DrawRectangleRoundedLines(btnXaxa, 0.2f, 10, 4, mortoXaxa ? GRAY : MAROON);
